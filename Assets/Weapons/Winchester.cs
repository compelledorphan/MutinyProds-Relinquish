...
public class Winchester : MonoBehaviour 
{
    ...
    void Start () 
    {
        tParam = 0;
        bZoom = false;
        Gun = GameObject.FindGameObjectWithTag("WinchesterObject") as GameObject;
    ...
    void Zoom()
    {
        ...
        {
            MainCam.fieldOfView = Mathf.Lerp(MainCam.fieldOfView, 30, Time.deltaTime * ZoomSpeed);
        }
        else
        {
            MainCam.fieldOfView = Mathf.Lerp(MainCam.fieldOfView, 60, Time.deltaTime * ZoomSpeed);
        }
    }
